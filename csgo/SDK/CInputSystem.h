...
public:
	...
	bool IsButtonDown(ButtonCode_e code)
	{
		typedef bool(__thiscall* OriginalFn)(void*, ButtonCode_e);
	...
	ButtonCode_e VirtualKeyToButtonCode(int nVirtualKey)
	{
		typedef ButtonCode_e(__thiscall* OriginalFn)(void*, int);
		return GetVFunc< OriginalFn >(this, 45)(this, nVirtualKey);
	}

	int ButtonCodeToVirtualKey(ButtonCode_e code)
	{
		typedef int(__thiscall* OriginalFn)(void*, ButtonCode_e);
